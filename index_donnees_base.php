...
<!--<div class="image">
    <img src="img\logiciels-gestion-stock.jpg" alt="stock">
</div>-->
...
<!--<div class="container">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-10">
                        <button type="button" name="add" id="addApplication" class="btn btn-success btn-xs"><i class="bi bi-plus-circle-fill"></i> Nouveau Magasin </button>
                    </div>
